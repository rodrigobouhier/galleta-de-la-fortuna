...
function generarFrese(len){
	let randomFrase = '';
	let frase = 'Tendrás un día de alegrías y buenos momentos, disfrútalos como nunca'
	...
	'Alégrate, un camino de hermosas pasiones te espera y debes transitarlo Nunca tendrás que preocuparte por un ingreso estable',
	...
	for(let i = 0; i< len; i++) {
		randomFrase += frase.charAt(Math.floor(Math.random() * frase.length));
	}
